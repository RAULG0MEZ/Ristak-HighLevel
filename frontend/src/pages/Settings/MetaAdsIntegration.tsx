...
import { CheckCircle, ExternalLink, ChevronDown, ChevronUp, AlertCircle } from 'lucide-react'
      ...
      <Card>
        <div className={styles.header}>
          <div className={styles.titleSection}>
            ...
            <div>
              <h3 className={styles.title}>Meta Ads (Facebook)</h3>
        ...
        <div className={styles.content}>
          ...
          <div className={styles.infoBanner}>
            <AlertCircle size={20} className={styles.infoBannerIcon} />
            <div className={styles.infoBannerContent}>
              <h4 className={styles.infoBannerTitle}>📊 ¿Para qué sirve esta integración?</h4>
          ...
          <div className={styles.introSection}>
            <h4 className={styles.sectionTitle}>🎯 Lo que vas a necesitar:</h4>
            <ul className={styles.checklist}>
              <li>Una cuenta de Meta Business Manager</li>
              <li>Una cuenta de anuncios de Facebook activa</li>
              <li>10-15 minutos para seguir los pasos</li>
              <li>Acceso a Meta Developers (gratis)</li>
            </ul>
          </div>

          {/* Tutorial paso a paso */}
          <div className={styles.tutorial}>
            <h4 className={styles.tutorialTitle}>📚 Tutorial Paso a Paso</h4>
            ...
            <div className={styles.step}>
              ...
              >
                ...
                <div className={styles.stepInfo}>
                  <h5 className={styles.stepTitle}>Crear una App en Meta Developers</h5>
                  ...
                  <ol className={styles.stepList}>
                    ...
                    <li>
                      ...
                      <ul className={styles.subList}>
                        ...
                        <li className={styles.warning}>⚠️ GUARDA ESTOS VALORES - Los necesitarás en el Paso 4</li>
                      </ul>
                    </li>
                  </ol>
            ...
            {/* Paso 2: Obtener el Access Token Permanente */}
            <div className={styles.step}>
              <div
                className={styles.stepHeader}
              ...
              >
                ...
                <div className={styles.stepInfo}>
                  <h5 className={styles.stepTitle}>Obtener un Token de Acceso Permanente (System User)</h5>
                    ...
                    <li>
                      ...
                      <ul className={styles.subList}>
                        ...
                        <li className={styles.warning}>
                          ...
                          <br />
                          <span className={styles.tokenExample}>Ejemplo: EAA...</span>
                        </li>
                      </ul>
                    </li>
                    <li>
            ...
            {/* Paso 3: Obtener tu Ad Account ID */}
            <div className={styles.step}>
              <div
                className={styles.stepHeader}
              ...
              >
                ...
                <div className={styles.stepInfo}>
                  <h5 className={styles.stepTitle}>Encontrar tu Ad Account ID</h5>
            ...
            <div className={styles.step}>
              ...
              >
                ...
                <div className={styles.stepInfo}>
                  <h5 className={styles.stepTitle}>Guardar los valores en HighLevel Custom Values</h5>
                    ...
                    <li>
                      ...
                      <div className={styles.customValuesTable}>
                        <div className={styles.tableRow}>
                          <div className={styles.tableHeader}>Nombre del Custom Value</div>
                          <div className={styles.tableHeader}>Valor que debes pegar</div>
                        </div>
                        <div className={styles.tableRow}>
                          <div className={styles.tableCell}>
                            <code>Facebook - Ad Account ID</code>
                          </div>
                          <div className={styles.tableCell}>
                            El número de tu cuenta de anuncios (Paso 3)
                            <br />
                            <span className={styles.example}>Ejemplo: 123456789012345</span>
                          </div>
                        </div>
                        <div className={styles.tableRow}>
                          <div className={styles.tableCell}>
                            <code>Facebook - App Access Token</code>
                          </div>
                          <div className={styles.tableCell}>
                            El token del System User (Paso 2)
                            <br />
                            <span className={styles.example}>Ejemplo: EAAabcdef...</span>
                          </div>
                        </div>
                        <div className={styles.tableRow}>
                          <div className={styles.tableCell}>
                            <code>Facebook - App ID</code>
                          </div>
                          <div className={styles.tableCell}>
                            El App ID de Meta Developers (Paso 1)
                            <br />
                            <span className={styles.example}>Ejemplo: 1234567890123456</span>
                          </div>
                        </div>
                        <div className={styles.tableRow}>
                          <div className={styles.tableCell}>
                            <code>Facebook - App Secret</code>
                          </div>
                          <div className={styles.tableCell}>
                            El App Secret de Meta Developers (Paso 1)
                            <br />
                            <span className={styles.example}>Ejemplo: abc123def456...</span>
                          </div>
                        </div>
                      </div>
                    </li>
            ...
            <div className={styles.step}>
              ...
              >
                ...
                <div className={styles.stepInfo}>
                  <h5 className={styles.stepTitle}>Sincronizar y verificar</h5>
          ...
          <div className={styles.faqSection}>
            <h4 className={styles.faqTitle}>❓ Preguntas Frecuentes</h4>

            <div className={styles.faq}>
              <h5 className={styles.faqQuestion}>¿El token del System User caduca?</h5>
              <p className={styles.faqAnswer}>
                No, el token del System User NO caduca nunca (a menos que lo revokes manualmente o cambies configuraciones de seguridad).
                Por eso es la mejor opción para integraciones.
              </p>
            </div>

            <div className={styles.faq}>
              <h5 className={styles.faqQuestion}>¿Puedo usar un token normal en vez del System User?</h5>
              <p className={styles.faqAnswer}>
            ...
            <div className={styles.faq}>
              <h5 className={styles.faqQuestion}>¿Qué métricas trae Ristak de Meta Ads?</h5>
              <p className={styles.faqAnswer}>
            ...
            <div className={styles.faq}>
              <h5 className={styles.faqQuestion}>¿Cada cuánto se actualizan los datos?</h5>
              <p className={styles.faqAnswer}>
            ...
            <div className={styles.faq}>
              <h5 className={styles.faqQuestion}>¿Es seguro guardar mi token en HighLevel?</h5>
              <p className={styles.faqAnswer}>
            ...
            <div className={styles.faq}>
              <h5 className={styles.faqQuestion}>¿Qué hago si me sale error al sincronizar?</h5>
              <p className={styles.faqAnswer}>
          ...
          <div className={styles.linksSection}>
            <h4 className={styles.linksTitle}>🔗 Links Útiles</h4>
            <div className={styles.linksList}>
              ...
              >
                Meta Developers <ExternalLink size={16} />
              </a>
              <a
                href="https://business.facebook.com"
                target="_blank"
                ...
                className={styles.externalLink}
              >
                Meta Business Manager <ExternalLink size={16} />
              </a>
              <a
                href="https://business.facebook.com/adsmanager"
                target="_blank"
                ...
                className={styles.externalLink}
              >
                Administrador de Anuncios <ExternalLink size={16} />
              </a>
              <a
                ...
                className={styles.externalLink}
              >
                Documentación Marketing API <ExternalLink size={16} />
              </a>
            </div>
          </div>
        </div>
