...
async function initTables() {
  try {
    ...
    await db.run('CREATE INDEX IF NOT EXISTS idx_whatsapp_api_config_status ON whatsapp_api_config(connection_status)')
    await db.run('CREATE INDEX IF NOT EXISTS idx_whatsapp_api_config_waba ON whatsapp_api_config(waba_id)')
    await db.run('CREATE INDEX IF NOT EXISTS idx_whatsapp_api_config_phone ON whatsapp_api_config(phone_number_id)')
    ...
    await db.run('CREATE INDEX IF NOT EXISTS idx_whatsapp_phone_numbers_waba ON whatsapp_phone_numbers(waba_id)')
    await db.run('CREATE INDEX IF NOT EXISTS idx_whatsapp_phone_numbers_config ON whatsapp_phone_numbers(config_id)')
    ...
    await db.run('CREATE INDEX IF NOT EXISTS idx_whatsapp_contacts_phone ON whatsapp_contacts(phone)')
    ...
    await db.run('CREATE INDEX IF NOT EXISTS idx_whatsapp_chats_phone_number ON whatsapp_chats(phone_number_id)')
    await db.run('CREATE INDEX IF NOT EXISTS idx_whatsapp_chats_wa_id ON whatsapp_chats(wa_id)')
    await db.run('CREATE INDEX IF NOT EXISTS idx_whatsapp_chats_last_message ON whatsapp_chats(last_message_at)')
    ...
    await db.run('CREATE INDEX IF NOT EXISTS idx_whatsapp_messages_chat ON whatsapp_messages(chat_id)')
    await db.run('CREATE INDEX IF NOT EXISTS idx_whatsapp_messages_phone_number ON whatsapp_messages(phone_number_id)')
    await db.run('CREATE INDEX IF NOT EXISTS idx_whatsapp_messages_wa_id ON whatsapp_messages(wa_id)')
    await db.run('CREATE INDEX IF NOT EXISTS idx_whatsapp_messages_timestamp ON whatsapp_messages(message_timestamp)')
    await db.run('CREATE INDEX IF NOT EXISTS idx_whatsapp_messages_status ON whatsapp_messages(status)')
    ...
    await db.run('CREATE INDEX IF NOT EXISTS idx_whatsapp_message_statuses_message ON whatsapp_message_statuses(meta_message_id)')
    await db.run('CREATE INDEX IF NOT EXISTS idx_whatsapp_message_statuses_phone ON whatsapp_message_statuses(phone_number_id)')
    await db.run('CREATE INDEX IF NOT EXISTS idx_whatsapp_message_statuses_status ON whatsapp_message_statuses(status)')
    ...
    await db.run('CREATE INDEX IF NOT EXISTS idx_whatsapp_onboarding_sessions_event ON whatsapp_onboarding_sessions(event)')
    await db.run('CREATE INDEX IF NOT EXISTS idx_whatsapp_onboarding_sessions_waba ON whatsapp_onboarding_sessions(waba_id)')
    await db.run('CREATE INDEX IF NOT EXISTS idx_whatsapp_onboarding_sessions_phone ON whatsapp_onboarding_sessions(phone_number_id)')
    ...
    await db.run('CREATE INDEX IF NOT EXISTS idx_whatsapp_webhook_events_waba ON whatsapp_webhook_events(waba_id)')
    await db.run('CREATE INDEX IF NOT EXISTS idx_whatsapp_webhook_events_phone ON whatsapp_webhook_events(phone_number_id)')
    await db.run('CREATE INDEX IF NOT EXISTS idx_whatsapp_webhook_events_field ON whatsapp_webhook_events(field)')
    await db.run('CREATE INDEX IF NOT EXISTS idx_whatsapp_webhook_events_received ON whatsapp_webhook_events(received_at)')
    ...
    await db.run('CREATE INDEX IF NOT EXISTS idx_whatsapp_sync_jobs_type ON whatsapp_sync_jobs(job_type)')
    await db.run('CREATE INDEX IF NOT EXISTS idx_whatsapp_sync_jobs_status ON whatsapp_sync_jobs(status)')
