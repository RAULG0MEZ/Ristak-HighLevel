...
export const saveMemoryTool = tool({
  ...
  execute: async ({ content }, runContext) => {
    const category = runContext?.context?.category || 'general'
...
export const forgetMemoryTool = tool({
  ...
  execute: async ({ memoryId }, runContext) => {
    const category = runContext?.context?.category || 'general'
...
export const memoryTools = [saveMemoryTool, forgetMemoryTool]
